...
genai.configure(api_key="AIzaSyDm1_VrnIMUmxbs8Z_12YyPJHTceqre9zc")

# ✅ Load the correct model
model = genai.GenerativeModel("models/gemini-1.5-pro")

# 🎨 App UI
st.set_page_config(page_title="Smart Answer Checker", page_icon="📚", layout="centered")
st.title("📚 Smart Answer Checker")
